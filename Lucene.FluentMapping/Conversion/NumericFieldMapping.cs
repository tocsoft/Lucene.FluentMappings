...
{
    public abstract class NumericFieldMapping<T, TProperty> : IFieldMap<T>, IConfigurable<T, NumericFieldOptions>
        where TProperty : struct
    {
        ...
        protected NumericFieldMapping(Expression<Func<T, TProperty>> property)
        {
